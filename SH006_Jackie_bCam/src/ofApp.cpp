...
//    line.endFrame = FDM.numFrames;
    ...
    gui.add(adjustments.set("adjustments", ofPoint(0, 0, 0), -ofPoint(200,200,400), ofPoint(200,200,400)));
	...
	string testSequenceFolder = dataPath + "bCam/";
...
void ofApp::draw(){
	...
	frame.img.draw(1920,0,-1920,1080);
    ofEnableDepthTest();
